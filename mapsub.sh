...
STAR --runThreadN 16 --genomeDir ~/project/stargenome/genome --genomeLoad LoadAndRemove --readFilesIn ${infile} ${infile/mate1/mate2} --outFileNamePrefix ${outfile} --outFilterIntronMotifs RemoveNoncanonical --outStd BAM_Unsorted --outSAMtype BAM Unsorted --outFilterType BySJout --outReadsUnmapped Fastx --outSAMattributes All --outSAMstrandField intronMotif > ${outfile}mapped.bam
